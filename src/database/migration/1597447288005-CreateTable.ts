...
export class CreateTable1597447288005 implements MigrationInterface {
    name = 'CreateTable1597447288005'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "atendimentos" ("id" SERIAL NOT NULL, "descricao_atendimento" character varying NOT NULL, "data_cadastro" TIMESTAMP NOT NULL, "usuarios_id_fk" integer, "empresas_id_fk" integer, CONSTRAINT "PK_80a70d057e68924b970871d9089" PRIMARY KEY ("id"))`);
