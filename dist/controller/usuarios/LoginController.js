...
var LoginBusiness_1 = __importDefault(require("../../business/usuarios/LoginBusiness"));
var LoginController = /** @class */ (function () {
    ...
    LoginController.prototype.login = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var usuario, loginBusiness, retorno, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        usuario = new Usuarios_1.Usuarios();
                        loginBusiness = new LoginBusiness_1.default();
                        usuario.nomeUsuario = String(request.headers.user);
                        usuario.senha = String(request.headers.password);
                        return [4 /*yield*/, loginBusiness.login(usuario)];
                    case 1:
                        retorno = _a.sent();
                        return [2 /*return*/, response.json(retorno)];
                    case 2:
                        error_1 = _a.sent();
