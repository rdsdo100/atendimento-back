...
var AtendimentosRepository_1 = __importDefault(require("../../repository/AtendimentosRepository"));
var AtendimentosBusiness = /** @class */ (function () {
    function AtendimentosBusiness() {
        this.atendimentosRepository = new AtendimentosRepository_1.default;
    }
    AtendimentosBusiness.prototype.cadastrarAtendimentos = function (atendimento) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atendimentosRepository.insertAtendimentoRepository(atendimento)];
                    case 1:
    ...
    AtendimentosBusiness.prototype.updateAtendimentos = function (atendimento) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atendimentosRepository.updateAtendimentosRepository(atendimento)];
                    case 1:
    ...
    AtendimentosBusiness.prototype.buscarAtendimentosUsuarios = function (idUsuario) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atendimentosRepository.buscarAtendimentoUsuarioRepository(idUsuario)];
                    case 1:
    ...
    AtendimentosBusiness.prototype.deletarAtendimentos = function (idAtendimento, idUsuario) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atendimentosRepository.buscarAtendimentoIdRepository(idAtendimento)];
                    case 1:
                        atendimento = _a.sent();
                        dataHoje = new Date;
                        dataAtendimento = atendimento.dataAtendimento;
    ...
    AtendimentosBusiness.prototype.buscarAtendimentosEmpresas = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atendimentosRepository.buscaEmpresaAtendimentos()];
                    case 1:
                        retorno = _a.sent();
