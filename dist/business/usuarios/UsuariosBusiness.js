...
var UsuariosBusiness = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, usuarioRepository_1.buscarUsuarioRepositoryAll()];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, usuarioRepository_1.insertUsuarioRpository(usuario)];
                    case 1:
                        resposta = _a.sent();
    ...
    UsuariosBusiness.prototype.updateUsuario = function (usuario) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, usuarioRepository_1.updateUsuarioRepository(usuario)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, usuarioRepository_1.deleteUsuarioIdRepository(idUsuarioDelete)];
                    case 2:
                        _a.sent();
