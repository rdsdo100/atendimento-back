...
var EmpresasRepository_1 = __importDefault(require("../../repository/EmpresasRepository"));
var EmpresasBusiness = /** @class */ (function () {
    function EmpresasBusiness() {
        this.grupoUsuarioRepostory = new UsuarioRepository_1.default;
        this.empresasRepository = new EmpresasRepository_1.default;
    }
    EmpresasBusiness.prototype.cadastrarEmpresas = function (empresa) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.empresasRepository.insertEmpresasRepository(empresa)];
                    case 1:
    ...
    EmpresasBusiness.prototype.listarEmpresas = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.empresasRepository.listEmpresasRepository()];
                    case 1:
    ...
    EmpresasBusiness.prototype.updateEmpresa = function (empresa) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.empresasRepository.updateEmpresaRpository(empresa)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.empresasRepository.buscarEmpresaIdRepository(idEmpresa)];
                    case 1:
                        empresa = _a.sent();
                        return [4 /*yield*/, this.grupoUsuarioRepostory.buscarUsuarioGrupoUsuarioId(idUsuario)];
                    case 2:
                        usuarios = _a.sent();
                        ...
                        return [4 /*yield*/, this.empresasRepository.deleteIdEmpresaRpository(idEmpresa)];
                    case 3:
                        _a.sent();
